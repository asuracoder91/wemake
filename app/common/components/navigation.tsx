...
const menus = [
	{
		...
		items: [
			...
			},
			{
				...
				description: "Submit a product to be featured",
				to: "/products/submit",
			},
			{
				name: "Promote",
	...
	},
	{
		...
		items: [
			...
			{
				name: "Submit a Job",
				description: "Submit a job to be featured",
				to: "/jobs/submit",
			},
		],
	},
	{
		...
		items: [
			...
			{
				name: "New Posts",
				description: "See the newest posts in the community",
	...
	},
	{
		...
		items: [
			...
			{
				name: "Create a Team",
				description: "Create a new team in the community",
				to: "/teams/create",
			},
		],
	},
							...
							<NavigationMenuItem key={menu.name}>
								{menu.items ? (
									<>
										...
										<NavigationMenuContent>
											<ul className="grid w-[w600px] font-light gap-3 p-4 grid-cols-2">
												{menu.items?.map((item) => (
													<NavigationMenuItem
														key={item.name}
														className={cn([
					...
					<DropdownMenu>
						...
						<DropdownMenuContent className="w-56">
							<DropdownMenuLabel className="flex flex-col">
								<span className="font-medium">Andrew Lee</span>
